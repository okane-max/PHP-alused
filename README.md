...
3. Kasutajaid saab lisada järgmisel kujul:<br />
  ``INSERT INTO `users` (`username`, `password`, `email`) VALUES
    ('peeter_pakiauto', '$2y$10$9ZoNP0lDx0H6RgSZ.wrx..PpzDGPFNeRwnxUbAq/W7y9HlWq/lFEG', 'peeter@auto.ee');``
4. Reserveeringuid saab lisada järgmisel kujul:<br />
  ``INSERT INTO `reservations` (`user_id`, `car_id`, `start_date`, `end_date`, `total_price`, `status`) VALUES
    (1, 4, '2026-06-03', '2026-06-13', 234.00, 'confirmed');``
